...
import com.jonasboner.remoting.proxy.util.UuidGenerator;
...
public class RemoteProxy implements InvocationHandler, Serializable {
     ...
     */
    private transient static Map<String, Object> s_instances = new WeakHashMap<String, Object>();
    ...
    public static RemoteProxy createClientProxy(final String[] interfaces,
        ...
        return RemoteProxy.createClientProxy(
                interfaces, impl, address, port, Thread.currentThread()
